...
public class TabItem extends View {
    private static final String TAG = TabItem.class.getName();
    ...
    public void setMode(int mode) {
        ...
        if ((mMode & TabLayoutMode.CHANGE_BACKGROUND_COLOR) > 0) {
            ...
            TabItem.this.setBackgroundResource(Utils
                    .getResourceId(mContext, R.attr.selectableItemBackgroundBorderless));
        }
    }
