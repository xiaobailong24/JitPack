...
public class Utils {
     ...
     * @return resourceId
     */
    public static int getResourceId(@NotNull Context context,
                                    @VolumeProviderCompat.ControlType int attrRes) {
     ...
     */
    public static int getAttrColor(@NotNull Context context,
                                   @VolumeProviderCompat.ControlType int attrRes) {
     ...
     */
    public static Drawable getAttrDrawable(@NotNull Context context,
                                           @VolumeProviderCompat.ControlType int attrRes) {
