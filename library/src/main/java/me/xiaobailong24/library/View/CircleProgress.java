...
import me.xiaobailong24.library.Utils.EaseInOutCubicInterpolator;
...
public class CircleProgress extends View {
    ...
    public void setDuration(long duration) {
        Log.d(TAG, "setDuration: " + String.valueOf(duration));
        mDuration = duration;
    }

    public void setRadius(float factor) {
        Log.d(TAG, "setRadius: " + String.valueOf(factor));
        stopAnim();
        calPoints(factor);
        startAnim();
    }
